...
function getDogNames1(dogs, filterFunc) {
  return dogs
    .filter(filterFunc)
    .map(dog => dog.name);
}

console.log(getDogNames1(dogs, dog => dog.weight < 20));

const weightCheck = weight => dog => dog.weight < weight;

console.log(getDogNames1(dogs, weightCheck(20)));

console.log(getDogNames1(dogs, weightCheck(50)));
...
console.log(getDogNames1(dogs, colorCheck('chocolate')));

console.log(getDogNames1(dogs, stateCheck('kansas')));
